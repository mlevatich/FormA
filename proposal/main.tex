...
% FIXME: any ideas for the name of the game?
...
\section{Introduction}
    ...
    video game called \Name{}. \Name{} is based loosely on the classic arcade
...
\section{Game Overview}
    ...
    \subsection{Gameplay}
        ...
        % FIXME: any fun features you want to add? Or things that would be
        % cool to model check?
...
\section{Correctness Specification}
    ...
    % FIXME: other ideas for formulas
...
\section{Verification Approach}
    ...
    % FIXME: describe how our coding process will integrate CBMC
